...
//	        
	     // Print Semester 2 Subject 1 and Subject 3 names
	        System.out.println("Semester 2, Subject 1: " + data[1][0][0]); // Mathematics II
	        System.out.println("Semester 2, Subject 3: " + data[1][0][2]); // Environmental Sci

	     // Print marks of Semester 1, Subject 3 and Subject 6
	        System.out.println("Semester 1, Subject 3 Marks: " + data[0][1][2]); // Chemistry - Fail(21)
	        System.out.println("Semester 1, Subject 6 Marks: " + data[0][1][5]); // Basic Electrical Eng. - Pass(79)	        
